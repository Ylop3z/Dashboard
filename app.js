...
// ==== Exponer funciones usadas en atributos onclick al objeto window ====
try { if (typeof addCallback === 'function') window.addCallback = addCallback; } catch(e) { /* ignore */ }
try { if (typeof addPart === 'function') window.addPart = addPart; } catch(e) { /* ignore */ }
try { if (typeof calculateMargin === 'function') window.calculateMargin = calculateMargin; } catch(e) { /* ignore */ }
try { if (typeof logout === 'function') window.logout = logout; } catch(e) { /* ignore */ }
try { if (typeof removeCallback === 'function') window.removeCallback = removeCallback; } catch(e) { /* ignore */ }
try { if (typeof removePart === 'function') window.removePart = removePart; } catch(e) { /* ignore */ }
try { if (typeof resetForm === 'function') window.resetForm = resetForm; } catch(e) { /* ignore */ }
try { if (typeof showMetrics === 'function') window.showMetrics = showMetrics; } catch(e) { /* ignore */ }
try { if (typeof toggleTheme === 'function') window.toggleTheme = toggleTheme; } catch(e) { /* ignore */ }
